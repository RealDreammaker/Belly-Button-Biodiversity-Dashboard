...
function handleSelection(id){
    ...
    d3.json("data/samples.json").then(function(data){
        ...
        // to see how much top OTUS from the total sample value
        ...
        var bulletData = [{
              ...
              mode: "number+gauge",
              value: totalTop10,
              title: { text: `<b>${Math.floor(totalTop10/totalSampleValue*100)}%</b>` },
              gauge: {
                shape: "bullet",
        ...
        console.log("IDs:",Math.max(...otu_ids));
        var trace1 = {
            x: otu_ids,
            y: sample_values,
            text: otu_labels,
        ...
        // data for drawing needle button
